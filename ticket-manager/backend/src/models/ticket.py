...
class Ticket(Base):
    ...
    brainstorm_round: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default="0")
    assigned_agent: Mapped[str | None] = mapped_column(String(255), nullable=True)
    override: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, server_default="false")
