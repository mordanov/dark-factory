...
async def engine_fixture():
    engine = create_async_engine(TEST_PG_URL, connect_args={"check_same_thread": False}, poolclass=StaticPool)
...
def user_token():
    ...
    s = get_settings()
    payload = {"sub": "uid-test", "is_admin": False, "type": "access",
...
def mock_tm():
    tm = MagicMock()
    tm.get_pending_tickets = AsyncMock(return_value=[
        {"id": "t-1", "project_id": "p-1", "title": "Test ticket",
         "description": "## Acceptance Criteria\n- [ ] works",
         "ticket_type": "feature", "tags": [], "fsm_status": "backlog",
         "blocked_reason": None, "brainstorm_round": 0, "assigned_agent": None,
         "override": False, "override_reason": None, "dependencies": [],
         "subtasks": [], "created_at": None, "updated_at": None}
    ])
    tm.get_ticket_full = AsyncMock(return_value={
        "id": "t-1", "project_id": "p-1", "title": "Test ticket",
        "description": "## Acceptance Criteria\n- [ ] works",
...
def sample_ticket():
    return TmTicket(
        id="t-1", project_id="p-1", title="Add login",
        description="## Acceptance Criteria\n- [ ] JWT login works",
        ticket_type="feature", tags=[], fsm_status="triage",
