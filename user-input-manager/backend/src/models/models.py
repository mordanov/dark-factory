...
class User(Base):
    ...
    sessions: Mapped[list[PromptSession]] = relationship(back_populates="user", cascade="all, delete-orphan")
...
class PromptSession(Base):
    ...
    tm_project_id: Mapped[str | None] = mapped_column(String(255))   # null for new projects until approved
    tm_project_name: Mapped[str | None] = mapped_column(String(255)) # stored for new projects before creation
