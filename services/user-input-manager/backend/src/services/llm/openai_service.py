...
Your role is to iteratively refine a user's task prompt until it is clear, complete, and
actionable for a software-development team.
...
def _build_messages(
    ...
    if iteration_history:
        ...
        for entry in iteration_history:
            ...
            parts.append(
                f"### {role_label} (iteration {entry['iteration_number']})\n{entry['text']}"
            )
