...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "session_type",
            postgresql.ENUM(
                "new_project", "existing_project", name="session_type", create_type=False
            ),
            nullable=False,
        ),
        ...
        sa.Column(
            "status",
            postgresql.ENUM(
                "in_progress", "approved", "cancelled", name="session_status", create_type=False
            ),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            postgresql.ENUM("user", "assistant", name="iteration_role", create_type=False),
            nullable=False,
        ),
