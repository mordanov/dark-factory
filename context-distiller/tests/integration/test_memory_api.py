...
async def test_list_adrs_default_accepted(test_client, mongo_db):
    await mongo_db.adrs.insert_many([
        {"_id": "ADR-001", "project_id": "proj-2", "title": "T1", "status": "accepted",
         "summary": "s", "content": "c", "ticket_id": "T-001",
         "created_at": datetime.now(timezone.utc).isoformat(),
         "updated_at": datetime.now(timezone.utc).isoformat()},
        {"_id": "ADR-002", "project_id": "proj-2", "title": "T2", "status": "proposed",
         "summary": "s", "content": "c", "ticket_id": "T-002",
         "created_at": datetime.now(timezone.utc).isoformat(),
         "updated_at": datetime.now(timezone.utc).isoformat()},
    ])
...
async def test_list_adrs_with_status_filter(test_client, mongo_db):
    await mongo_db.adrs.insert_many([
        {"_id": "ADR-010", "project_id": "proj-3", "title": "T1", "status": "proposed",
         "summary": "s", "content": "c", "ticket_id": "T-001",
         "created_at": datetime.now(timezone.utc).isoformat(),
         "updated_at": datetime.now(timezone.utc).isoformat()},
    ])
...
async def test_list_adrs_all_status(test_client, mongo_db):
    await mongo_db.adrs.insert_many([
        {"_id": "ADR-020", "project_id": "proj-4", "title": "T1", "status": "accepted",
         "summary": "s", "content": "c", "ticket_id": "T-001",
         "created_at": datetime.now(timezone.utc).isoformat(),
         "updated_at": datetime.now(timezone.utc).isoformat()},
        {"_id": "ADR-021", "project_id": "proj-4", "title": "T2", "status": "proposed",
         "summary": "s", "content": "c", "ticket_id": "T-002",
         "created_at": datetime.now(timezone.utc).isoformat(),
         "updated_at": datetime.now(timezone.utc).isoformat()},
    ])
...
async def test_patch_adr_status_valid_transition(test_client, mongo_db):
    await mongo_db.adrs.insert_one({
        "_id": "ADR-100", "project_id": "proj-6", "title": "T", "status": "proposed",
        "summary": "s", "content": "c", "ticket_id": "T-001",
        "created_at": datetime.now(timezone.utc).isoformat(),
        "updated_at": datetime.now(timezone.utc).isoformat(),
    })
...
async def test_patch_adr_status_invalid_transition_returns_409(test_client, mongo_db):
    await mongo_db.adrs.insert_one({
        "_id": "ADR-101", "project_id": "proj-7", "title": "T", "status": "accepted",
        "summary": "s", "content": "c", "ticket_id": "T-001",
        "created_at": datetime.now(timezone.utc).isoformat(),
        "updated_at": datetime.now(timezone.utc).isoformat(),
    })
